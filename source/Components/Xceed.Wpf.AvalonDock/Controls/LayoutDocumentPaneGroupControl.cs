...
namespace Xceed.Wpf.AvalonDock.Controls
{
  public class LayoutDocumentPaneGroupControl : LayoutGridControl<ILayoutDocumentPane>, ILayoutControl
  {
    ...
    {
      _model = model;
      this.SizeChanged += LayoutDocumentPaneGroupControl_SizeChanged;
    }
    ...
    protected override void OnFixChildrenDockLengths()
    {
      ...
      else
      {
        ...
        private void LayoutDocumentPaneGroupControl_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            var modelWithActualSize = _model as ILayoutPositionableElementWithActualSize;
            ////System.Console.WriteLine("LayoutDocumentPaneGroupControl ActualSize {0},{1} -> {2},{3}",
